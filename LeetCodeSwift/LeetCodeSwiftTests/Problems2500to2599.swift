...
final class Problems2500to2599: XCTestCase {
    ...
    func test_Problem2501() throws {
        XCTAssertEqual(Problem2501().test([4, 3, 6, 16, 8, 2]), 3)
        XCTAssertEqual(Problem2501().test([2, 3, 5, 6, 7]), -1)
    }
    ...
    func test_Problem2563() throws {
        XCTAssertEqual(Problem2563().test([0, 1, 7, 4, 4, 5], 3, 6), 6)
        XCTAssertEqual(Problem2563().test([1, 7, 9, 2, 5], 11, 11), 1)
    }
