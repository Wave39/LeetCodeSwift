...
class Problems1to99: XCTestCase {
    ...
    func test_Problem18() throws {
        let solve1 = Problem18().test([1, 0, -1, 0, -2, 2], 0)
        XCTAssertTrue(solve1.count == 3)
        XCTAssertTrue(solve1.contains([-2, -1, 1, 2]))
        XCTAssertTrue(solve1.contains([-2, 0, 0, 2]))
        XCTAssertTrue(solve1.contains([-1, 0, 0, 1]))
        XCTAssertEqual(Problem18().test([2, 2, 2, 2, 2], 8), [[2, 2, 2, 2]])
        XCTAssertEqual(Problem18().test([0], 0), [])
    }
    ...
    func test_Problem40() throws {
        XCTAssertEqual(Problem40().test([10, 1, 2, 7, 6, 1, 5], 8), [[1, 1, 6], [1, 2, 5], [1, 7], [2, 6]])
        XCTAssertEqual(Problem40().test([2, 5, 2, 1, 2], 5), [[1, 2, 2], [5]])
    }
    ...
    func test_Problem78() throws {
        XCTAssertEqual(Problem78().test([1, 2, 3]), [[], [1], [2], [1, 2], [3], [1, 3], [2, 3], [1, 2, 3]])
        XCTAssertEqual(Problem78().test([0]), [[], [0]])
    }
