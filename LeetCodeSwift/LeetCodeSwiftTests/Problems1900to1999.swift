...
class Problems1900to1999: XCTestCase {
    ...
    func test_Problem1942() throws {
        XCTAssertEqual(Problem1942().test([[1, 4], [2, 3], [4, 6]], 1), 1)
        XCTAssertEqual(Problem1942().test([[3, 10], [1, 5], [2, 6]], 0), 2)
    }
    ...
    func test_Problem1963() throws {
        ...
        XCTAssertEqual(Problem1963().test("[]"), 0)
    }

    func test_Problem1978() throws {
        XCTAssertTrue(Problem1978().test())
    }
