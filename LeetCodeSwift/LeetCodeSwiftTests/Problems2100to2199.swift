...
final class Problems2100to2199: XCTestCase {
    ...
    func test_Problem2185() throws {
        XCTAssertEqual(Problem2185().test(["pay", "attention", "practice", "attend"], "at"), 2)
        XCTAssertEqual(Problem2185().test(["leetcode", "win", "loops", "success"], "code"), 0)
    }
