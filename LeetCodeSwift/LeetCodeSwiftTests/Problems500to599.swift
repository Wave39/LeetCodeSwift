...
class Problems500to599: XCTestCase {
    ...
    func test_Problem501() throws {
        XCTAssertEqual(Problem501().test(TreeNode([1, nil, 2, 2])), [2])
        XCTAssertEqual(Problem501().test(TreeNode([0])), [0])
    }
    ...
    func test_Problem570() throws {
        XCTAssertTrue(Problem570().test())
    }

    func test_Problem577() throws {
        XCTAssertTrue(Problem577().test())
    }

    func test_Problem584() throws {
        XCTAssertTrue(Problem584().test())
    }
